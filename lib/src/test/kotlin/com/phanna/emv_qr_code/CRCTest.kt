...
class CRCTest {
    ...
    @Test
    fun verifyCRC() {
        val isValid = CRC.validate("00020101021252044131153137210116372101160123456789ABCDE6016Banteay Meanchey5913Kuntheas Shop5802KH540510.005303840621201081234567863041FF2")
